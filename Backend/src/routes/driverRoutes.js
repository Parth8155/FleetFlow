...
router.get('/', authorize('manager', 'dispatcher', 'safety'), driverController.getAllDrivers)
...
router.get('/:id', authorize('manager', 'dispatcher', 'safety'), driverController.getDriverById)
